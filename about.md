...
백엔드 개발자를 준비하고 있습니다. Flown LMS 프로젝트에서 결제, 주문, 수강권, 영상 진도, 학습 스케줄 관련 API를 구현했고, 기능 구현 이후의 배포·운영 흐름까지 같이 다뤄보는 데 관심이 있습니다.

최근에는 같은 요청이 반복되거나 외부 API가 실패해도 서비스 흐름이 쉽게 무너지지 않도록 만드는 방법, 그리고 운영 중 문제를 빠르게 확인할 수 있는 구조를 공부하고 있습니다.
